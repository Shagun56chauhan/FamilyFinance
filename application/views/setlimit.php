...
<div class="container">
    <h1 class="heading" style="color:  #2A9D8F;">Set Limit</h1>



    <form action="<?php echo base_url('SetLimit/submit_btn') ?>" method="post" class="forms">
        ...
        <div class="forms2">
            ...
            <div class="mb-3">
                <label for="set_limit" class="form-label">Set Limit</label>
                <input type="number" step="0.01" id="amount" name="set_limit" class="form-control"
